...
/* harmony import */ var _solicitations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./solicitations */ "./resources/js/solicitations.js");
/* harmony import */ var _solicitations__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_solicitations__WEBPACK_IMPORTED_MODULE_1__);
...
window.sortTable = function (column) {
  var table = document.getElementById("solicitations-table");
  ...
  rows.sort(function (a, b) {
    var aValue = a.dataset[column];
    var bValue = b.dataset[column];
    var comparison = 0;
...
window.updateSortIcons = function () {
  var icons = document.querySelectorAll('i[id$="-sort-icon"]');
  icons.forEach(function (icon) {
    icon.classList.remove("fa-sort-up", "fa-sort-down");
    icon.classList.add("fa-sort");
  });
  var currentIcon = document.getElementById(currentOrderBy + "-sort-icon");
  if (currentIcon) {
